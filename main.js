...
process.stdout.write(defaultAgent+"\n");
  ...
  //
  var userAgent = "XX Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36";
...
app.on('ready', () => {
  ...
  tray.setToolTip('TTTH - Talk To The Hand.');
